...
final class PostProcessorRegistrationDelegate {
	...
	public static void invokeBeanFactoryPostProcessors(
		...
		if (beanFactory instanceof BeanDefinitionRegistry) {
			...
			//遍历beanFactoryPostProcessors得到所有的BeanFactoryPostProcessor
			...
			//第一步，先执行实现 PriorityOrdered接口的BeanDefinitionRegistryPostProcessor
			...
			//执行实现Ordered接口中BeanDefinitionRegistryPostProcessor
	...
	public static void registerBeanPostProcessors(
		...
		//先获取所有的BeanPostProcessor；后置处理器默认通过PriorityOrdered、Ordered接口来执行优先级
